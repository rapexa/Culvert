...
def Draw_wing_walls(WingWalls,ProjectName):
        ...
        with open(config.WING_WALLS_DXF, "r") as f:
        ...
        OUTPUT_WING_WALLS_DXF_FILE_NAME = config.OUTPUT_WING_WALLS_DXF + '-' + ProjectName + ".dxf"
...
def Draw_single_grain_culvert(singleGrain,HS,ProjectName):
        ...
        with open(config.ONE_SPAN_CULVERT_DXF, "r") as f:
        ...
        OUTPUT_ONE_SPAN_CULVERT_DXF_FILE_NAME = config.OUTPUT_ONE_SPAN_CULVERT_DXF + '-' + ProjectName + ".dxf"
...
def Draw_Two_grain_culvert(threeGrain,HS,ProjectName):
        ...
        with open(config.TWO_SPAN_CULVERT_DXF, "r") as f:
        ...
        OUTPUT_TWO_SPAN_CULVERT_DXF_FILE_NAME = config.OUTPUT_TWO_SPAN_CULVERT_DXF + '-' + ProjectName + ".dxf"
...
def Draw_Three_grain_culvert(threeGrain,HS,ProjectName):
        ...
        with open(config.THREE_SPAN_CULVERT_DXF, "r") as f:
        ...
        OUTPUT_THREE_SPAN_CULVERT_DXF_FILE_NAME = config.OUTPUT_THREE_SPAN_CULVERT_DXF + '-' + ProjectName + ".dxf"
