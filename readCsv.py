...
def readFileCsvFileDimensionsOfThreeGrain():
    ...
    with open(config.DIMENSIONS_OF_THREE_GRAIN_FILE, "r") as csv_file_Dimensions_of_three_grain:
...
def readFileDimensionsOfSingleGrain():
    ...
    with open(config.DIMENSIONS_OF_SINGLE_GRAIN_FILE, "r") as csv_file_Dimensions_of_single_grain:
...
def readFileDimensionsOfWingWalls():
    ...
    with open(config.DIMENSIONS_OF_WING_WALLS_FILE, "r") as csv_file_Dimensions_of_wing_walls:
